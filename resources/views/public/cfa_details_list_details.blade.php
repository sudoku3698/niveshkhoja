...
<body>
	...
	<section class="pg-list-1">
		<div class="container">
			<div class="row">
				<div class="pg-list-1-left"> <a href="#"><h3 id="title_name">{{$table->CFA_COMPANY_NAME}}</h3></a>
					...
					<h4 id="title_branch">{{$table->CFA_ADDRESS}}</h4>
					<p id="title_address"><b>Address:</b> {{$table->CFA_ADDRESS}}</p>
					<div class="list-number pag-p1-phone">
						<ul>
							<li><i class="fa fa-phone" aria-hidden="true"></i><span id="title_contact"> {{$table->CFA_CONTACT}}</span></li>
							<li><i class="fa fa-envelope" aria-hidden="true"></i> <span id="title_email">{{$table->CFA_EMAIL_ID}}</span></li>
							<li><i class="fa fa-user" aria-hidden="true"></i><span id="title_contact_person"> {{$table->CFA_CONTACT_PERSON}}</span></li>
						</ul>
					</div>
				</div>
					...
					<div class="list-pg-lt list-page-com-p">
						...
						<div class="pglist-p2 pglist-bg pglist-p-com" id="ld-ser">
							...
							<div class="list-pg-inn-sp">
								...
								<ul>
								@if($table->CFA_SERVICES_OFFERED)
									@foreach(explode(',',$table->CFA_SERVICES_OFFERED) as $service)
									<li>{{$service}}</li>
									@endforeach
								</ul>
								@endif
					...
					<div class="list-pg-rt">
						...
						<div class="list-mig-like">
							<div class="list-ri-spec-tit">
								...
								@foreach($service_list->slice(0, 4) as $service_li)
									...
									<div class="list-mig-like-com">
										...
										<div class="list-mig-lc-con">
											...
											<h5><a href="{{Route('list-details',['service'=>Session('service'),'id'=>$service_li->id])}}">{{$service_li->CFA_CONTACT_PERSON}}</a></h5>
								...
								@endforeach
								<a href="{{Route('get_service_by_name',['service_type'=>'cfa_details'])}}">more</a>
						</div>
