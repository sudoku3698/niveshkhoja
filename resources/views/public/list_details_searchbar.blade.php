		...
		<div class="container top-search-main">
			<div class="row">
				<div class="ts-menu">
					<!--SECTION: LOGO-->
					<div class="ts-menu-1">
						<a href="{{Route('landing')}}"><img src="{{ asset('bank_khoja_ui/images/aff-logo.png')}}" alt=""> </a>
					</div>
						...
						<div class="">
							<form class="tourz-search-form tourz-top-search-form" method="post" action="{{Route('searchServices')}}">
								<div class="input-field">
									<input required type="text"  name="city" id="top-select-city" class="autocomplete" autocomplete="off">
									<label for="top-select-city">Enter city</label>
								</div>
								<div class="input-field">
									<input required type="text" name="service" id="top-select-search" class="autocomplete" autocomplete="off">
									<label for="top-select-search" class="search-hotel-type">Search your services like hotel, resorts, events and more</label>
								</div>
								<div class="input-field">
									<input type="submit" value="submit" class="waves-effect waves-light tourz-top-sear-btn"></div>
							</form>
						</div>
					</div>
