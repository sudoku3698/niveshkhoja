...
<body>
	...
	<section class="pg-list-1">
		<div class="container">
			<div class="row">
				<div class="pg-list-1-left"> <a href="#"><h3 id="title_name">{{$table->POST_OFFICE_NAME}}</h3></a>
					...
					<h4 id="title_branch">{{$table->POST_OFFICE_ADDRESS}}</h4>
					<p id="title_address"><b>Address:</b> {{$table->POST_OFFICE_ADDRESS}}</p>
					<div class="list-number pag-p1-phone">
						<ul>
							<li><i class="fa fa-phone" aria-hidden="true"></i><span id="title_contact"> {{$table->POST_OFFICE_CONTACT_PERSON}}</span></li>
							<li><i class="fa fa-envelope" aria-hidden="true"></i> <span id="title_email">{{$table->POST_OFFICE_EMAIL_ID}}</span></li>
							<li><i class="fa fa-user" aria-hidden="true"></i><span id="title_contact_person"> {{$table->POST_OFFICE_CONTACT_PERSON}}</span></li>
						</ul>
					</div>
				</div>
					...
					<div class="list-pg-lt list-page-com-p">
					    ...
					    <div class="pglist-p1 pglist-bg pglist-p-com" id="ld-abour">
							...
							<div class="list-pg-inn-sp">
	                           <p> <h5>{{$table->POST_OFFICE_ABOUT}}</h5></p>
							    <table style="padding:5px;line-height: 3;">
							        <tr>
							            <td><h5>POST OFFICE TYPE :- </h5></td>
							            <td style="text-align:left;"><b>{{$table->POST_OFFICE_TYPE}}</b></td>
							        </tr>
							        <tr>
							            <td><h5>POST OFFICE DELIVERY :- </h5></td>
							            <td style="text-align:left;"><b>{{$table->POST_OFFICE_DELIVERY}}</b></td>
							        </tr>
							        <tr>
							            <td><h5>POST OFFICE REGION :- </h5></td>
							            <td style="text-align:left;"><b>{{$table->POST_OFFICE_REGION}}</b></td>
							        </tr>
							        <tr>
							            <td><h5>POST OFFICE CIRCLE :- </h5></td>
							            <td style="text-align:left;"><b>{{$table->POST_OFFICE_CIRCLE}}</b></td>
							        </tr>
							        <tr>
							            <td><h5> YEAR ESTABLISH :- </h5></td>
							            <td style="text-align:left;"><b>{{$table->POST_OFFICE_YEAR_ESTABLISH}}</b></td>
							        </tr>
							        <tr>
							            <td><h5> REVIEW :- </h5></td>
							            <td style="text-align:left;"><b>{{$table->POST_OFFICE_REVIEW}}</b></td>
							        </tr>
						...
						<div class="pglist-p2 pglist-bg pglist-p-com" id="ld-ser">
							...
							<div class="list-pg-inn-sp">
								...
								<ul>
								@if($table->POST_OFFICE_SERVICES_OFFERED)
									@foreach(explode(',',$table->POST_OFFICE_SERVICES_OFFERED) as $service)
									<li>{{$service}}</li>
									@endforeach
								</ul>
								@endif
					...
					<div class="list-pg-rt">
						...
						<div class="list-mig-like">
							<div class="list-ri-spec-tit">
								...
								@foreach($service_list->slice(0, 5) as $service_li)
									...
									<div class="list-mig-like-com">
										...
										<div class="list-mig-lc-con">
											...
											<h5><a href="{{Route('list-details',['service'=>Session('service'),'id'=>$service_li->id])}}">{{$service_li->POST_OFFICE_NAME}}</a></h5>
								...
								@endforeach
								<a href="{{Route('get_service_by_name',['service_type'=>'post_office_details'])}}">more</a>
						</div>
