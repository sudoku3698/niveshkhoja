...
<body>
	...
	<section class="pg-list-1">
		<div class="container">
			<div class="row">
				<div class="pg-list-1-left"> <a href="#"><h3 id="title_name">{{$table->BANK_NAME}}</h3></a>
					...
					<h4 id="title_branch">{{$table->BANK_BRANCH}}</h4>
					<p id="title_address"><b>Address:</b> {{$table->BANK_ADDRESS}}</p>
					<div class="list-number pag-p1-phone">
						<ul>
							<li><i class="fa fa-phone" aria-hidden="true"></i><span id="title_contact"> {{$table->BANK_CONTACT}}</span></li>
							<li><i class="fa fa-envelope" aria-hidden="true"></i> <span id="title_email">{{$table->BANK_EMAIL_ID}}</span></li>
							<li><i class="fa fa-user" aria-hidden="true"></i><span id="title_contact_person"> {{$table->BANK_CONTACT}}</span></li>
						</ul>
					</div>
				</div>
	                           ...
	                           <p> <h5>{{$table->BANK_ABOUT}}</h5></p>
							    <table style="padding:5px;line-height: 3;">
							        <tr>
							            ...
							            <td style="text-align:left;"><b>{{$table->BANK_IFSC_CODE}}</b></td>
							        </tr>
							        <tr>
							            <td><h5>BANK MICR CODE :- </h5></td>
							            <td style="text-align:left;"><b>{{$table->BANK_MICR_CODE}}</b></td>
							        </tr>
							        <tr>
							            <td><h5>BANK BRANCH :- </h5></td>
							            <td style="text-align:left;"><b>{{$table->BANK_BRANCH}}</b></td>
							        </tr>
							        <tr>
							            <td><h5>BANK YEAR ESTABLISH :- </h5></td>
							            <td style="text-align:left;"><b>{{$table->BANK_YEAR_ESTABLISH}}</b></td>
							        </tr>
							        <tr>
							            <td><h5>BANK REVIEW :- </h5></td>
							            <td style="text-align:left;"><b>{{$table->BANK_REVIEW}}</b></td>
							        </tr>
						...
						<div class="list-mig-like">
							...
							<div class="list-mig-like-com">
								...
								<div class="list-mig-lc-con">
									...
									<h5><a href="{{Route('list-details',['service'=>Session('service'),'id'=>$service_li->id])}}">{{$service_li->BANK_NAME}}</a></h5>
							...
							@endforeach
							<a href="{{Route('get_service_by_name',['service_type'=>'bank_details'])}}">more</a>
						</div>
