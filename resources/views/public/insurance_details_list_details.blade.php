...
<body>
	...
	<section class="pg-list-1">
		<div class="container">
			<div class="row">
				<div class="pg-list-1-left"> <a href="#"><h3 id="title_name">{{$table->INSURANCE_INSURER}}</h3></a>
					...
					<h4 id="title_branch">{{$table->INSURANCE_ADDRESS}}</h4>
					<p id="title_address"><b>Address:</b> {{$table->INSURANCE_ADDRESS}}</p>
					<div class="list-number pag-p1-phone">
						<ul>
							<li><i class="fa fa-phone" aria-hidden="true"></i><span id="title_contact"> {{$table->INSURANCE_CONTACT}}</span></li>
							<li><i class="fa fa-envelope" aria-hidden="true"></i> <span id="title_email">{{$table->INSURANCE_EMAIL_ID}}</span></li>
							<li><i class="fa fa-user" aria-hidden="true"></i><span id="title_contact_person"> {{$table->INSURANCE_CONTACT_PERSON}}</span></li>
						</ul>
					</div>
				</div>
					...
					<div class="list-pg-lt list-page-com-p">
						...
						<div class="pglist-p2 pglist-bg pglist-p-com" id="ld-ser">
							...
							<div class="list-pg-inn-sp">
								...
								<ul>
								@if($table->INSURANCE_SERVICES_OFFERED)
									@foreach(explode(',',$table->INSURANCE_SERVICES_OFFERED) as $service)
									<li>{{$service}}</li>
									@endforeach
								</ul>
								@endif
					...
					<div class="list-pg-rt">
						...
						<div class="list-mig-like">
							<div class="list-ri-spec-tit">
								...
								@foreach($service_list->slice(0, 5) as $service_li)
									...
									<div class="list-mig-like-com">
										...
										<div class="list-mig-lc-con">
											...
											<h5><a href="{{Route('list-details',['service'=>Session('service'),'id'=>$service_li->id])}}">{{$service_li->INSURANCE_INSURER}}</a></h5>
								...
								@endforeach
								<a href="{{Route('get_service_by_name',['service_type'=>'insurance_details'])}}">more</a>
						</div>
