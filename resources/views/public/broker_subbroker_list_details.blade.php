...
@include('public.list_details_searchbar')
	...
	<section class="pg-list-1">
		<div class="container">
			<div class="row">
				<div class="pg-list-1-left"> <a href="#"><h3 id="title_name">{{$table->BROKER_CONTACT}}</h3></a>
					...
					<h4 id="title_branch">{{$table->BROKER_ADDRESS}}</h4>
					<p id="title_address"><b>Address:</b> {{$table->BROKER_ADDRESS}}</p>
					<div class="list-number pag-p1-phone">
						<ul>
							<li><i class="fa fa-phone" aria-hidden="true"></i><span id="title_contact"> {{$table->BROKER_CONTACT}}</span></li>
							<li><i class="fa fa-envelope" aria-hidden="true"></i> <span id="title_email">{{$table->BROKER_EMAIL_ID}}</span></li>
							<li><i class="fa fa-user" aria-hidden="true"></i><span id="title_contact_person"> {{$table->BROKER_CONTACT_PERSON}}</span></li>
						</ul>
					</div>
				</div>
					...
					<div class="list-pg-lt list-page-com-p">
						<!--LISTING DETAILS: LEFT PART 1-->
			             <div class="pglist-p1 pglist-bg pglist-p-com" id="ld-abour">
							...
							<div class="list-pg-inn-sp">
	                           <p> <h5>{{$table->BROKER_ABOUT}}</h5></p>
							    <table style="padding:5px;line-height: 3;">
							        <tr>
							            <td><h5>BROKER REGISTRATION NUMBER :- </h5></td>
							            <td style="text-align:left;"><b>{{$table->BROKER_REGISTRATION_NUMBER}}</b></td>
							        </tr>
							        <tr>
							            <td><h5>BROKER RECOMMENDING BROKER REG NUMBER :- </h5></td>
							            <td style="text-align:left;"><b>{{$table->BROKER_RECOMMENDING_BROKER_REG_NUMBER}}</b></td>
							        </tr>
							        <tr>
							            <td><h5>BROKER STOCK EXCHANGE :- </h5></td>
							            <td style="text-align:left;"><b>{{$table->BROKER_STOCK_EXCHANGE}}</b></td>
							        </tr>
							        <tr>
							            <td><h5>YEAR ESTABLISH :- </h5></td>
							            <td style="text-align:left;"><b>{{$table->BROKER_YEAR_ESTABLISH}}</b></td>
							        </tr>
							        <tr>
							            <td><h5> REVIEW :- </h5></td>
							            <td style="text-align:left;"><b>{{$table->BROKER_REVIEW}}</b></td>
							        </tr>
						...
						<div class="pglist-p2 pglist-bg pglist-p-com" id="ld-ser">
							...
							<div class="list-pg-inn-sp">
								...
								<ul>
								@if($table->BROKER_SERVICES_OFFERED)
									@foreach(explode(',',$table->BROKER_SERVICES_OFFERED) as $service)
									<li>{{$service}}</li>
									@endforeach
								</ul>
								@endif
					...
					<div class="list-pg-rt">
						...
						<div class="list-mig-like">
							<div class="list-ri-spec-tit">
								...
								@foreach($service_list->slice(0, 4) as $service_li)
							<a href="#!">
							<div class="list-mig-like-com">
								...
								<div class="list-mig-lc-con">
									...
									<h5><a href="{{Route('list-details',['service'=>Session('service'),'id'=>$service_li->id])}}">{{$service_li->BROKER_CONTACT_PERSON}}</a></h5>
							...
							@endforeach
							<a href="{{Route('get_service_by_name',['service_type'=>'broker_subbroker'])}}">more</a>
						</div>
